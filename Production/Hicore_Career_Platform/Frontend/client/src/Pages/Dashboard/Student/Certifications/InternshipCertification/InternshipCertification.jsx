...
import InternshipItems from './InternshipItems';
      ...
      <div className="w-full px-4 ">
        ...
        <div className="flex flex-col gap-[24px] md:gap-[36px] mb-[24px] md:mb-[36px] ">
          ...
          <div className="flex flex-wrap items-center gap-1 justify-center border-b border-[#343079] pb-4">
            <Filter label="Domain" options={domainOptions} value={selectedDomain} onChange={setSelectedDomain} />
            <Filter label="Location" options={locationOptions} value={selectedLocation} onChange={setSelectedLocation} />
            <Filter label="Stipend" options={stipendOptions} value={selectedStipend} onChange={setSelectedStipend} />
            <Filter label="Duration" options={durationOptions} value={selectedDuration} onChange={setSelectedDuration} />
          </div>
        </div>
      </div>
