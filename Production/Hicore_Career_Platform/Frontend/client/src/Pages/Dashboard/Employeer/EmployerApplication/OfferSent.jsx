...
import shortlistedData from "./OfferSentData";
...
export default function OfferSent() {
  ...
  const { totalOfferSent, ribbonLabel, candidates } = shortlistedData;
  ...
  return (
    <div className="p-6 min-h-screen text-gray-100">
      ...
      {/* Heading */}
      <h2 className="text-2xl text-left font-semibold text-[#008000] mb-6">
        {totalOfferSent} Applications {ribbonLabel}
      </h2>
        ...
        {filtered.map((c) => (
          ...
          >
            ...
            <div className="absolute top-4 right-0">
              <span className="bg-[#008000] rounded-tl-full rounded-bl-full text-[#FFFFFF] px-4 py-2 text-sm font-medium whitespace-nowrap">
                {ribbonLabel}
              </span>
            </div>
