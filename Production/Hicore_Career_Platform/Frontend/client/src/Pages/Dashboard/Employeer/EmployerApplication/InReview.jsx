...
import shortlistedData from "./InReviewData";
...
export default function InReview() {
  ...
  const { totalInReview, ribbonLabel, candidates } = shortlistedData;
  ...
  return (
    <div className="p-6 min-h-screen text-gray-100">
      ...
      {/* Heading */}
      <h2 className="text-2xl text-left font-semibold text-[#34C78C] mb-6">
        {totalInReview} Applications {ribbonLabel}
      </h2>
        ...
        {filtered.map((c) => (
          ...
          >
            ...
            <div className="absolute top-4 right-0">
              <span className="bg-[#34C78C] rounded-tl-full rounded-bl-full text-[#FFFFFF] px-4 py-2 text-sm font-medium whitespace-nowrap">
                {ribbonLabel}
              </span>
            </div>
