...
import allIcon from "../../../../assets/MentorAllPage/Badge.png";
      ...
      {!showProjects ? (
        <div className="flex flex-col items-center justify-center text-center w-full h-[80vh]">
          <img
            ...
            className="w-24 h-24 mb-4 mx-auto opacity-60"
          />
          ...
          <button
            ...
            className="bg-[#3D2C8D] text-white text-sm font-medium px-6 py-2 rounded-md shadow hover:bg-[#2c1f66]"
          >
            Search Projects
          </button>
        </div>
      ) : (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-6xl mx-auto mt-8">
          {categories.map((item) => (
            <div
              key={item.id}
