        ...
        switch (type) {
          ...
          case "heading":
            return (
              <h2
                key={idx}
                className="text-[#343079] font-bold text-[16px] leading-8 whitespace-pre-line"
              >
                {block.text}
              </h2>
            );
          ...
          case "paragraph":
            return (
              <p
                key={idx}
                className="text-[#343079] text-[14px] leading-6 whitespace-pre-line"
              >
                {block.text}
              </p>
            );
          ...
          case "formula":
            return (
              <div
                key={idx}
                className="p-3 bg-gray-100 border-l-4 border-purple-500 w-fit font-mono text-[14px] rounded whitespace-pre-line"
              >
                {block.text}
              </div>
            );
          ...
          case "task":
            return (
              <div
                key={idx}
                className="p-8 bg-green-50 w-fit border-l-4 border-green-500 rounded text-[14px]"
              >
          ...
          case "code":
            return (
              <pre
                key={idx}
                className="bg-[#F9F9FC] p-8 rounded-md border text-[14px] font-mono overflow-x-auto whitespace-pre-wrap break-words"
              >
            ...
            return (
              <div key={idx} className="space-y-3 mt-2">
                {block.items?.map((note, nIdx) => (
                  <div key={nIdx}>
                    <h4 className="font-semibold text-[16px] mb-1 whitespace-pre-line">
                      {note.title}
                    </h4>
          ...
          default:
            return (
              <pre
                key={idx}
                className="text-gray-500 text-xs bg-gray-50 p-2 rounded whitespace-pre-wrap"
              >
