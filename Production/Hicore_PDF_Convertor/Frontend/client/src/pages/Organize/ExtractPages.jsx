// src/pages/tools/ExtractPages.jsx
...
const ExtractPages = () => {
  ...
  const handleExtractPages = async () => {
    ...
    if (!pageNumbers.trim()) return alert("Please enter pages to extract.");
    ...
    try {
      const actionRes = await fetch(`${API_BASE}/api/tool-action`, {
        ...
        body: JSON.stringify({ tool: "organize", action: "extract_pdf" }),
      });
      ...
      fd.append("action", "extract_pdf");
      fd.append("settings", JSON.stringify({ pages: pageNumbers }));
      fd.append("pages", pageNumbers);
          ...
          <div className="col-span-9 relative">
            <div className="flex items-center justify-start bg-[#F7E6E9]/[0.30] border border-[#F3D9DD] rounded-md px-4 py-6">
              <div className="flex items-center gap-10">
                <button
                  onClick={() => navigate("/tools/extract-pages")}
              ...
              {resultUrl ? (
                ...
                <div className="flex flex-col items-center text-gray-400">
                  ...
                  <p className="text-xs px-4 text-center leading-relaxed">
                    {isProcessing
                      ? "Processing your PDF..."
                      : "Enter pages to extract and click Extract."}
                  </p>
                </div>
              )}
              {error && (
              ...
              onClick={
                resultUrl
                  ? () => {
                      ...
                      a.href = resultUrl;
                      a.download = `extracted_${file?.name || "result.pdf"}`;
                      a.click();
                    }
                  : handleExtractPages
              }
              ...
              <div className="mt-5 flex-1 overflow-y-auto custom-scrollbar">
                ...
                <div className="border border-[#E7B0B9] bg-[#F7E6E9]/[30%] rounded-md p-4">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-[#E7B0B9] bg-white rounded text-sm mb-2 focus:outline-none"
                  />
                  <p className="text-[11px] text-gray-500">
                    Required: specified pages will be returned.
                  </p>
                </div>
                ...
                <div className="mt-8 pt-5 border-t border-[#E7B0B9]/50">
                  ...
                  <ul className="space-y-3 text-[13px] text-gray-600">
                    <li className="flex gap-2">
                      <span>•</span>{" "}
                      <span>Comma separated pages (e.g. 1,3,5)</span>
                    </li>
                    <li className="flex gap-2">
                      <span>•</span> <span>Order is preserved as entered.</span>
                    </li>
                  </ul>
                </div>
              </div>
