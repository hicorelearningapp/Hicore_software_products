      ...
      <div className="max-w-7xl mx-auto mt-20 px-6">
        <div className="text-center">
          <h1 className="text-[#115D29] font-extrabold text-3xl md:text-4xl lg:text-5xl leading-tight mb-6">
           Transform Your Medicine Distribution with Smart Automation
          </h1>

          <p className="max-w-3xl mx-auto text-[16px] md:text-[18px] text-gray-500 mb-8">
          Manage inventory, fulfill retailer orders, and analyze market trends — all in one AI-driven ecosystem designed for distributors.
          </p>
          ...
          <div className="mt-6">
            ...
            >
              <span className="text-base md:text-lg">Get Started as a Distributor</span>
