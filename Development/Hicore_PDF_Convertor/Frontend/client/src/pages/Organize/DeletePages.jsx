// src/pages/tools/DeletePages.jsx
...
const DeletePages = () => {
  ...
  const handleDeletePages = async () => {
    ...
    if (!pageNumbers.trim()) return alert("Please enter pages to delete.");
    ...
    try {
      const actionRes = await fetch(`${API_BASE}/api/tool-action`, {
        ...
        body: JSON.stringify({ tool: "organize", action: "delete_pages" }),
      });
      ...
      fd.append("pages_to_delete", pageNumbers);
          ...
          <div className="col-span-9 relative">
            <div className="flex items-center justify-start bg-[#F7E6E9]/[0.30] border border-[#F3D9DD] rounded-md px-4 py-6">
              <div className="flex items-center gap-10">
                <button
                  onClick={() => navigate("/tools/delete-pages")}
              ...
              {resultUrl ? (
                ...
                <div className="flex flex-col items-center text-gray-400">
                  ...
                  <p className="text-xs px-4 text-center leading-relaxed">
                    {isProcessing
                      ? "Processing your PDF..."
                      : "Enter pages to remove and click Delete."}
                  </p>
                </div>
              )}
            </div>
              ...
              onClick={
                resultUrl
                  ? () => {
                      ...
                      a.href = resultUrl;
                      a.download = `deleted_${file?.name || "result.pdf"}`;
                      a.click();
                    }
                  : handleDeletePages
              }
          ...
          <div className="col-span-3">
            <aside className="bg-gray-50 rounded-lg p-4 h-[75vh] flex flex-col">
              ...
              <div className="mt-5 flex-1 overflow-y-auto custom-scrollbar">
                ...
                <div className="border border-[#F3D9DD] bg-[#F7E6E9]/[0.30] rounded-md p-4">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-[#F3D9DD] bg-white rounded text-sm mb-2"
                  />
                ...
                <div className="mt-8 pt-5 border-t border-[#E7B0B9]/50">
                  ...
                  <ul className="space-y-3 text-[13px] text-gray-600">
                    <li className="flex gap-2">
                      <span>•</span> <span>Page numbers start from 1.</span>
                    </li>
                    <li className="flex gap-2">
                      <span>•</span>{" "}
                      <span>Entering "2,4" removes exactly those pages.</span>
                    </li>
                  </ul>
                </div>
              </div>
